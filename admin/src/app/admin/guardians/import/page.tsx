          ...
          <div className="flex items-center justify-center">
            <Card className="w-full">
              <CardContent className="flex flex-col items-center justify-center p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Import Guardians</h3>

                <p className="text-muted-foreground mb-6 text-sm">
                  This feature is currently under development. Soon you'll be
                  able to bulk import guardians from CSV or Excel files.
                </p>
                ...
                <div className="mt-6 p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg w-full">
                  <p className="text-xs text-blue-600 dark:text-blue-400">
                    💡 <strong>Tip:</strong> For now, you can add guardians
                    individually using the "New Guardians" button on the main
                    guardian page.
                  </p>
                </div>
              </CardContent>
