...
func (_c *OrganizationCreate) AddUserIDs(ids ...int) *OrganizationCreate {
...
func (_c *OrganizationCreate) check() error {
	...
	if _, ok := _c.mutation.Logo(); !ok {
		return &ValidationError{Name: "logo", err: errors.New(`ent: missing required field "Organization.logo"`)}
	}
	...
	if _, ok := _c.mutation.Website(); !ok {
		return &ValidationError{Name: "website", err: errors.New(`ent: missing required field "Organization.website"`)}
	}
